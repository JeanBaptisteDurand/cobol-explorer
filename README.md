...
[![tests](https://img.shields.io/badge/tests-151%20backend%20%C2%B7%2048%20e2e-42be65)](#8-tests)
...
- **Stack** — Python / FastAPI (agent + ingestion) + React / TypeScript (frontend); self-hosted Neo4j + pgvector + Granite (Ollama), or **Granite on IBM watsonx.ai**. 151 backend tests · 48 e2e.
...
cd web && pnpm exec playwright test # 48 e2e (landing, inscription, connexion, aperçu, code, impact, cowork)
