...
```bash
make test                           # 151 backend tests (parsing, graph, impact, search, versioning, API, MCP, auth, sign-up)
cd web && pnpm exec playwright test # 49 e2e (landing, sign-up, sign-in, overview, code, impact, cowork, tour, RBAC)
