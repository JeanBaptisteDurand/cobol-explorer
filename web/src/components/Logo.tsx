 ...
 *  amber square is the entity you are about to change; the three outlined squares are
...
export default function Logo({ size = 22, title }: { size?: number; title?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none"
      ...
      <g stroke="var(--amber-d)" strokeWidth="1.5" strokeLinecap="round">
        <path d="M11 16 H21" />
        <path d="M12.5 12 L20 7.5" />
        <path d="M12.5 20 L20 24.5" />
      </g>
      {/* the impacted set */}
      <g stroke="var(--dim)" strokeWidth="1.6" fill="none">
      ...
      <rect x="2.6" y="11.4" width="9.2" height="9.2" rx="2.2" fill="var(--amber)" />
    </svg>
  );
}
