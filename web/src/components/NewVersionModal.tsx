    ...
    <div className="scrim" onClick={onClose}>
      <div className="modal" style={{ width: 400 }} onClick={(e) => e.stopPropagation()}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 7 }}>
          <Icon name="branch" size={15} color="var(--amber)" />
          <span style={{ font: "600 12.5px var(--s)", color: "var(--tx)" }}>New version</span>
        </div>
        <p style={{ font: "400 12px/1.55 var(--s)", color: "var(--dim)", margin: "0 0 20px" }}>
        ...
        <div style={{ display: "flex", gap: 9 }}>
          <button className="btn-pri" style={{ flex: 1, justifyContent: "center", font: "600 12px var(--s)", padding: 10, borderRadius: 6, border: "none" }} onClick={submit} data-testid="nv-create">Create version</button>
